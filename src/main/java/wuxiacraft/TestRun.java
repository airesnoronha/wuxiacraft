...
import wuxiacraft.cultivation.technique.TechniqueGrid;
...
public class TestRun {
	...
	public static void testStuff() {
		...
		grid.addGridNode(new Point(1,0), new ResourceLocation(WuxiaCraft.MOD_ID, "fire_connect_to_body_1"));
		grid.addGridNode(new Point(+2,-1), new ResourceLocation(WuxiaCraft.MOD_ID, "body_gathering"));
