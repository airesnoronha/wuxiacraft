...
public class SystemStats {
	...
	public double getModifier() {
		...
		double foundationAmount = this.getFoundation() + 0.3 * MathUtils.clamp(this.getBase() - this.getLevel().getBaseBySubLevel(this.getSubLevel()), 0, this.getLevel().getBaseBySubLevel(this.getSubLevel())*7);
