...
public class WanderingCultivator extends EntityCreature implements IEntityAdditionalSpawnData {
	...
	public WanderingCultivator(World worldIn) {
		...
		applyRandomCultivation(worldIn);
	...
	protected void applyRandomCultivation(World world) {;
		if(world.provider.getDimensionType().getId() == 0) {
			...
			this.skillCap.addSkill(Skills.FLAMES);
		}
	}
