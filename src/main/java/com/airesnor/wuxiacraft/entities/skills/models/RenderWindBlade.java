...
import com.airesnor.wuxiacraft.entities.skills.WindBladeThrowable;
...
public class RenderWindBlade<T extends WindBladeThrowable> extends Render<T> {

	public RenderWindBlade(RenderManager renderManager) {
		super(renderManager);
		renderOutlines = true;
	}
	...
	public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		GlStateManager.color(0.02f, 0.7f, 0.9f, 0.6f);
