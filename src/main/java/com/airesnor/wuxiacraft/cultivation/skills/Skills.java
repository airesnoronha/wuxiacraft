...
public class Skills {
    ...
    public static final Skill EARTH_SUCTION = new Skill("earth_suction", 20f, 0.8f, 10f, 0f).setAction(new ISkillAction() {
        @Override
        public boolean activate(EntityPlayer actor) {
            boolean activated = false;
    ...
    public static final Skill EARTHLY_WALL = new Skill("earthly_wall", 20f, 0.8f, 10f, 0f).setAction(new ISkillAction() {
        @Override
        public boolean activate(EntityPlayer actor) {
            boolean activated = false;
            RayTraceResult rtr = actor.rayTrace(5, 1f);
