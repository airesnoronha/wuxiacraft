...
public class BaseSystemLevel {
	...
	public static void initializeLevels() {
		...
		ESSENCE_LEVELS.add(new BaseSystemLevel("essence_godhood_2", "essence_godhood_3", "Void True God", 9, 113235986928378.00, 29294397.78, true, true));
		...
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_immortal_1", "divine_immortal_2", "King Soul", 9, 7054903.53, 1269.19, true, false));
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_immortal_2", "divine_immortal_3", "Emperor Soul", 9, 187825047.84, 14976.50, true, false));
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_immortal_3", "divine_godhood_1", "Immortal Soul", 9, 10369096617.65, 176722.67, true, false));
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_godhood_1", "divine_godhood_2", "Divine Soul", 9, 989172587340.57, 2212567.81, true, true));
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_godhood_2", "divine_godhood_3", "Divine Imperishable Soul", 9, 113235986928378.00, 29294397.78, true, true));
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_godhood_3", "divine_godhood_3", "Divine World Defying Soul", 9, 38706539279813700.00, 451133725.75, true, true));
		...
		ESSENCE_LEVELS.add(new BaseSystemLevel("essence_godhood_2", "essence_godhood_3", "God King", 9, 113235986928378.00, 5265471.04, true, true ));
		...
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_immortal_1", "divine_immortal_2", "Spiritual Sense", 9, 7054903.53, 984.9, true, false ));
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_immortal_2", "divine_immortal_3", "Spiritual Foundation", 9, 187825047.84, 8076.22, true, false ));
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_immortal_3", "divine_godhood_1", "Spiritual Core", 9, 10369096617.65, 66225.01, true, false ));
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_godhood_1", "divine_godhood_2", "Divine Sense", 9, 989172587340.57, 574833.08, true, true ));
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_godhood_2", "divine_godhood_3", "Divine Will", 9, 113235986928378.00, 5265471.04, true, true ));
		DIVINE_LEVELS.add(new BaseSystemLevel("divine_godhood_3", "divine_godhood_3", "True Soul World", 9, 38706539279813700.00, 55813992.98, true, true ));
