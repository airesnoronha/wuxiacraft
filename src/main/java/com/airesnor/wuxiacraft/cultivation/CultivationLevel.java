...
public class CultivationLevel extends IForgeRegistryEntry.Impl<CultivationLevel> {
	...
	static {
		DEFAULTS.add(new CultivationLevel("body_refinement", "soul_refinement", 5, 10, 1000F, 1.00F, 1.00F, false, false, false, false, false, false, false));
		DEFAULTS.add(new CultivationLevel("soul_refinement","qi_paths_refinement", 5, 80, 1790.85F, 1.20F, 3.00F, false, false, false, false, false, false, false));
		DEFAULTS.add(new CultivationLevel("qi_paths_refinement","dantian_condensing", 5, 696, 3399.56F, 1.46F, 9.6F, false, false, false, false, false, false, false));
		DEFAULTS.add(new CultivationLevel("dantian_condensing","earth_law", 5, 6542, 6840.59F, 1.82F, 32.64F, false, false, false, false, false, true, false));
		DEFAULTS.add(new CultivationLevel("earth_law","sky_law", 10,75238, 16393.87F, 2.36F, 130.56F, false, false, false, false, false, true, false));
		DEFAULTS.add(new CultivationLevel("sky_law","true_law", 10,865232, 39288.87F, 3.07F, 522.24F, true, false, false, false, false, true, false));
		DEFAULTS.add(new CultivationLevel("true_law","martial_law", 10,10555835, 99807.54F, 4.05F, 2193.41F, true, false, true, false, false, true, true));
		DEFAULTS.add(new CultivationLevel("martial_law","immortality_law", 10,136170275, 268759.03F, 5.43F, 9651.00F, true, false, true, false, false, true, true));
		DEFAULTS.add(new CultivationLevel("immortality_law","immortality_refinement", 15,2042554127, 861946.62F, 7.60F, 48254.98F, true, false, true, false, false, true, true));
		DEFAULTS.add(new CultivationLevel("immortality_refinement","immortal_foundation", 15,30638311900L, 2764379.58F, 10.64F, 241274.88F, true, false, true, false, false, true, true));
		DEFAULTS.add(new CultivationLevel("immortal_foundation","true_immortal", 15,481021496833L, 9397684.19F, 15.10F, 1254629.38F, true, true, true, true, false, true, true));
		DEFAULTS.add(new CultivationLevel("true_immortal","martial_immortal", 15,7888752548063L, 33864906.62F, 21.75F, 6774998.68F, true, true, true, true, false, true, true));
		DEFAULTS.add(new CultivationLevel("martial_immortal","divine_law", 20,145941922139175L, 145343801.14F, 32.62F, 40649991.78F, true, true, true, true, false, true, true));
		DEFAULTS.add(new CultivationLevel("divine_law","divine_phenomenon", 20,2699925559574730L, 623796804.43F, 48.93F, 243899950.69F, true, false, true, true, true, true, true));
		DEFAULTS.add(new CultivationLevel("divine_phenomenon","true_god", 20,51838570743834800L, 2837890554.39F, 74.38F, 1512179694.31F, true, true, true, true, true, true, true));
		DEFAULTS.add(new CultivationLevel("true_god","true_god", 1000000,1031587557802310000L, 13685289995.12F, 114.55F, 9677950043.55F, true, true, true, true, true, true, true));
	}
