...
public enum TechniqueTier {
	MORTAL("wuxiacraft.tier.mortal", 1500f, 5000f, 20000f),
	MARTIAL("wuxiacraft.tier.martial", 3000f, 10000f, 50000f),
	IMMORTAL("wuxiacraft.tier.immortal", 5000f, 15000f, 100000f),
	DIVINE("wuxiacraft.tier.divine", 10000f, 50000f, 500000f);
