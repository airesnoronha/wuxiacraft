package com.airesnor.wuxiacraft.dimensions.ChunkGen;
...
public class MiningChunkGen implements IChunkGenerator
{
    ...
    //Gravel and soul sand that generates in the nether
    protected static final IBlockState SIDE_BLOCK1 = Blocks.COAL_ORE.getDefaultState();
    protected static final IBlockState SIDE_BLOCK2 = Blocks.DIRT.getDefaultState();
    ...
    public MiningChunkGen(World worldIn, boolean p_i45637_2_, long seed)
    {
        this.world = worldIn;
                            ...
                            if (iblockstate2.getBlock() == Blocks.NETHERRACK)
                            {
                                if (i1 == -1)
                                {
                                    ...
                                    else if (j1 >= i - 4 && j1 <= i + 1)
                                    {
                                        ...
                                        if (flag1)
                                        {
                                            iblockstate = SIDE_BLOCK1;
                                            iblockstate1 = MAIN_BLOCK;
                                        }

                                        if (flag)
                                        {
                                            iblockstate = SIDE_BLOCK2;
                                            iblockstate1 = SIDE_BLOCK2;
                                        }
                                    }
    ...
    {
        return "Fortress".equals(structureName);
    }
