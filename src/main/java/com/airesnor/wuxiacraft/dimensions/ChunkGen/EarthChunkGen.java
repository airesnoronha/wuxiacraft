...
public class EarthChunkGen implements IChunkGenerator
{
    protected static final IBlockState STONE = Blocks.DIRT.getDefaultState();
    ...
    public EarthChunkGen(World worldIn, long seed) {
