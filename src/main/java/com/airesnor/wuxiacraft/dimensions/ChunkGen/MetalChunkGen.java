...
public class MetalChunkGen implements IChunkGenerator
{
    protected static final IBlockState STONE = WuxiaBlocks.METALLIC_STONE.getDefaultState();
    protected static final IBlockState GRAVEL = Blocks.IRON_ORE.getDefaultState();
    ...
    public MetalChunkGen(World worldIn, long seed) {
