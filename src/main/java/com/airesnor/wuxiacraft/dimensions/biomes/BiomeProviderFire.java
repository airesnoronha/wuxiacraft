...
import com.airesnor.wuxiacraft.dimensions.worldtypes.genlayer.GenLayerFixFire;
...
public class BiomeProviderFire extends BiomeProvider {
    ...
    public BiomeProviderFire() {
        this.biomeCache = new BiomeCache(this);
    }

    public BiomeProviderFire(long seed) {
        this();
        GenLayer[] aGenLayer = GenLayerFixFire.createWorld(seed);
