...
import com.airesnor.wuxiacraft.world.dimensions.ChunkGen.FireChunkGen;
import com.airesnor.wuxiacraft.world.dimensions.biomes.BiomeProviderFire;
...
public class DimensionFire extends WorldProvider {
    ...
    public boolean canCoordinateBeSpawn(int x, int z) {
        ...
        if (this.world.getGroundAboveSeaLevel(blockpos).getBlock() == Blocks.DIRT) {
            canSpawnHere = true;
        }
        return canSpawnHere;
    }
