...
import com.airesnor.wuxiacraft.world.dimensions.genlayer.GenLayerFixWater;
...
public class BiomeProviderWater extends BiomeProvider {

    private GenLayer genBiomes;
    private GenLayer biomeIndexLayer;
    private BiomeCache biomeCache;

    public BiomeProviderWater() {
        this.biomeCache = new BiomeCache(this);
    }

    public BiomeProviderWater(long seed) {
        this();
        GenLayer[] aGenLayer = GenLayerFixWater.createWorld(seed);
        this.genBiomes = aGenLayer[0];
        this.biomeIndexLayer = aGenLayer[1];
    }

    public BiomeProviderWater(World world) {
        this(world.getSeed());
    }
