...
import com.airesnor.wuxiacraft.world.dimensions.genlayer.GenLayerFixWood;
...
public class BiomeProviderWood extends BiomeProvider {

    private GenLayer genBiomes;
    private GenLayer biomeIndexLayer;
    private BiomeCache biomeCache;

    public BiomeProviderWood() {
        this.biomeCache = new BiomeCache(this);
    }

    public BiomeProviderWood(long seed) {
        this();
        GenLayer[] aGenLayer = GenLayerFixWood.createWorld(seed);
        this.genBiomes = aGenLayer[0];
        this.biomeIndexLayer = aGenLayer[1];
    }

    public BiomeProviderWood(World world) {
        this(world.getSeed());
    }
